...
OUT="/home/smalkaram/Projects/travis20180117151534/TRIM/MIRDEEP_MAPPER"
MINLEN=16
MULTIPLE=5
# Change the path as needed
...
mapperMOD.pl mapping_file2.txt $MIRDEEP_MAPPER_OPTIONS -s reads.fa -t reads_vs_genome.arf
