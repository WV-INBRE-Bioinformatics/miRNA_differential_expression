...
WD=`pwd`
# Change the output 
RESULT="/home/smalkaram/Projects/travis20180117151534/TRIM/MIRDEEP_MAPPER/MIRDEEP2_run3/quantify_all_mature_novel/result_19_01_2018_t_13_46_29.csv"
READS="/home/smalkaram/Projects/travis20180117151534/TRIM/MIRDEEP_MAPPER/MIRDEEP2_run3/quantify_all_mature_novel/reads2.fa"
SPECIES="mmu"
TIME=`date +"%Y%m%d%H%M%S"`

perl /home/smalkaram/Projects/travis20180117151534/TRIM/MIRDEEP_MAPPER/MIRDEEP2_run3/quantify_all_mature_novel/quantify_all_mature_novel.pl $RESULT
mkdir -p $WD/NOVEL
